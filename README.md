...
3. Open the extracted files and copy the DataFiles folder and OBBB.ese file. Go to your current sector file folder for OBBB and replace the DataFiles and .ese file with the ones you just copied. 
